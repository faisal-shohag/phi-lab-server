...
exports.default = pixelmatchCustom;
/**
 ...
 */
function pixelmatchCustom(img1, img2, output, width, height, options = {}) {
    const { threshold = 0.1, alpha = 0.1, aaColor = [255, 255, 0], diffColor = [255, 0, 0], includeAA, diffColorAlt, diffMask } = options;
