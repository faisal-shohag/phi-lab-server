export const topFoods = [
  ...
  },
  {
    ...
    cuisine:
      "Mediterranean-inspired / Modern Healthy / Fusion (lemon-herb grilled style with Italian influences from basil and tomatoes)",
    origin_and_popularity:
  ...
  },
  {
    ...
    possible_price_in_dhaka: {
      ...
      "cafe_or_Italian-inspired_eatery":
        "BDT 500-900 (premium versions with imported cheese)",
    },
    cuisine:
      "Italian-American / Italian-inspired (classic comfort with marinara sauce and cheese stuffing)",
    origin_and_popularity:
  ...
  },
  {
    ...
    possible_price_in_dhaka: {
      ...
      street_food_or_small_restaurant:
        "BDT 250-450 (if available as kids' special)",
      cafe_or_healthy_eatery:
        "BDT 400-700 (premium fun/kid-focused versions in places like Gulshan cafes or meal prep services)",
    },
    cuisine:
      "Modern Healthy / Kids' Fusion (Western-inspired fun food art with emphasis on colorful veggies and breaded protein)",
    origin_and_popularity:
    ...
    image_link:
      "https://res.cloudinary.com/dj493l0jy/image/upload/v1773986501/foods/903c138d-e103-4487-8ebd-44dd91ac9338.png",
  },
  {
    id: "food_005",
    ...
    possible_price_in_dhaka: {
      ...
      cafe_or_healthy_eatery:
        "BDT 600-1000 (common in upscale spots like Gulshan/Banani cafes, health-focused restaurants, or delivery apps)",
    },
    cuisine:
      "Mediterranean-inspired / Modern Healthy Fusion (with South American chimichurri influence and Western salad bowl style)",
    origin_and_popularity:
    ...
    image_link:
      "https://res.cloudinary.com/dj493l0jy/image/upload/v1773919302/foods/7b210282-1035-42da-a858-4ed58127633f.png",
  },
  {
    id: "food_006",
    dish_name:
    ...
    possible_price_in_dhaka: {
      ...
      cafe_or_healthy_upscale_eatery:
        "BDT 800-1500 (common in premium brunch spots in Gulshan, Banani, Dhanmondi cafes or high-end delivery like Pathao/Foodpanda fusion menus)",
    },
    cuisine:
      "Modern Fusion / Brunch / Creative Plating (American comfort meets international brunch trends with artistic presentation)",
    origin_and_popularity:
    ...
    image_link:
      "https://res.cloudinary.com/dj493l0jy/image/upload/v1773919355/foods/8885d5f9-26b6-4312-b326-7e06822e5744.png",
  },
  {
    id: "food_007",
    dish_name:
    ...
    possible_price_in_dhaka: {
      ...
      street_food_or_small_restaurant:
        "BDT 300-550 (similar to Vietnamese-inspired spots or fusion rice bowls)",
      cafe_or_healthy_eatery:
        "BDT 500-900 (common in Gulshan/Banani cafes, health-focused places, or delivery apps with Asian fusion menus)",
    },
    ...
    image_link:
      "https://res.cloudinary.com/dj493l0jy/image/upload/v1773919402/foods/b43372b1-1be5-44b7-ade5-a544b8d70539.png",
  },
  {
    id: "food_008",
    ...
    possible_price_in_dhaka: {
      ...
      cafe_or_upscale_eatery:
        "BDT 700-1500 (common in Gulshan/Banani/Dhanmondi fusion Bengali restaurants, premium thali specials, or delivery apps like Foodpanda/Pathao with gourmet plating)",
    },
    cuisine:
      "Bengali / Bangladeshi (traditional thali with modern fusion presentation)",
    origin_and_popularity:
      "Deeply rooted in Bengali cuisine (shared by Bangladesh and West Bengal, India); thali format for everyday or festive meals (e.g., Pohela Boishakh, family gatherings). Features balance of flavors/textures per tradition (bitter start, then dal, bhaja, curry, chutney). Modern colorful platters popular in urban Dhaka cafes, social media food trends, and restaurants offering 'gourmet Bengali' or veg/non-veg thalis",
    cooking_steps: [
    ...
    image_link:
      "https://res.cloudinary.com/dj493l0jy/image/upload/v1773919467/foods/9f660c76-6c57-42e4-a033-c98e710e4e16.png",
  },
  {
    id: "food_009",
    ...
    possible_price_in_dhaka: {
      ...
      street_food_or_small_restaurant: "BDT 350-600",
      cafe_or_healthy_eatery:
        "BDT 500-900 (common in Gulshan/Banani/Dhanmondi spots, salad bars, or delivery apps like Foodpanda with seafood salads around 400-700 BDT)",
    },
    cuisine:
      "Mediterranean-inspired / Modern Healthy (with influences from American/seafood salads or coastal Asian styles)",
    origin_and_popularity:
    ...
    image_link:
      "https://res.cloudinary.com/dj493l0jy/image/upload/v1773919513/foods/e2af330e-27a7-42ab-8cc9-07da6978601f.png",
  },
  {
    id: "food_010",
    ...
    possible_price_in_dhaka: {
      ...
      cafe_or_Indian_eatery:
        "BDT 500-1000 (common in Gulshan/Banani/Dhanmondi Indian restaurants like those on Foodpanda/Pathao; premium versions ~BDT 700-900)",
    },
